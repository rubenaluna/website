...
export const AboutSection: FC = () => {
  ...
  return (
    <section id="about" className="about w-screen h-screen">
      <div className="about-header w-full h-12 flex items-center px-6 py-4 space-x-2">
        <div className="w-3 h-3 bg-white"></div>
        <h2 className="text-lg uppercase mono text-gray-400">ABOUT ME</h2>
      </div>
      <div className="about-body w-screen h-screen flex flex-col px-6">
        <h3 className="about-title mono text-4xl lg:text-5xl leading-tight uppercase py-6 font-light text-gray-200">
          Full-Stack Web Development
        </h3>
        <div className="about-content h-[calc(100%-16rem)] flex bg-white/5 rounded-2xl p-8 border border-white/10">
          <div className="w-full h-full flex-1 flex flex-col justify-center items-center space-y-4">
            <img
              ...
              alt="Ruben Luna"
            />
            <div className="bg-black/30 backdrop-blur-md rounded-xl p-8">
              <p className="text-md text-gray-300">
                {getGreeting()}, I'm Ruben Luna. I'm a software developer based
                out of the Dallas-Fort Worth area of Texas. I have specialized
                in building frictionless and intricate web applications for over
                six years. My experience in both front-end and back-end
                development enables me to bring ideas to life from concept to
                delivery.
              </p>
            </div>
          </div>
