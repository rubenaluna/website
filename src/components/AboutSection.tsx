  ...
  return (
    <div className="about w-screen h-screen">
      ...
      <div className="about-body max-w-7xl h-full mx-auto flex flex-col justify-center px-6">
        <section
          id="skills"
          className="about-content min-h-128 flex flex-col bg-white/5 rounded-2xl p-8 border border-white/10 justify-center items-center"
        >
          ...
          <div className="w-full h-full flex-1 flex flex-col justify-center items-center space-y-4">
            ...
            <p className="text-md text-gray-300">
              I'm Ruben Luna, a software developer based out of the Dallas-Fort
              Worth area of Texas. I have specialized in building frictionless
              and intricate web applications for over six years. My full-stack
              experience enables me to bring ideas to life from back-end to
              front-end and concept to delivery.
            </p>
          </div>
          <div className="w-full h-full flex flex-1 justify-center items-center mx-12">
            <Accordion
              id="about-skills"
            ...
            >
              <AccordionItem
                className="border-none w-full about-skill-be mx-12"
              ...
              <AccordionItem
                className="border-none w-full about-skill-fe mx-12"
              ...
              <AccordionItem
                className="border-none w-full about-skill-ops mx-12"
                value="Operations"
              >
                <AccordionTrigger className="mono uppercase text-lg font-light text-gray-400">
                  Operations
                ...
                <AccordionContent className="text-minimal-light">
                  <div className="border-bottom-gray-600 border-b py-2">
                    Kubernetes, Docker, Redis, RabbitMQ, Git
                  </div>
                  <div className="border-bottom-gray-600 border-b py-2">
                    AWS, Azure
                  </div>
